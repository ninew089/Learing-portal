...
export const data = [
  ...
  {
    question: "การลงชื่อเข้าใช้ (Sign In)",
    answer:
      "สามารถลงชื่อเข้าใช้ได้สองวิธี <br/>1. ลงชื่อเข้าใช้จากเว็บโดยตรง <br/>2. ลงชื่อเข้าใช้ ETDA Connect ",
  },
  {
    question: "ถ้าข้าราชการพลเรือน",
    answer: "สามารถลงชื่อเข้าใช้ผ่าน ETDA ได้ ",
  },
  {
