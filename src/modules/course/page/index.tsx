...
const Relation = lazy(() => import("modules/relation/components/Relation"));
const Portal = lazy(() => import("modules/portal/components/LinkPortal"));
const TapsCourse = lazy(() => import("../components/Course/TapsCourse"));
const AllCourse = lazy(() => import("../components/Course/AllCourse"));
const SocialCardDemo = lazy(
  () => import("../components/CardRecomment/CardRecomment")
);
const GroupSearch = lazy(() => import("../components/Search"));
const Curriculum = lazy(
  () => import("../components/Curriculum/CategoryByCurriculum")
);
